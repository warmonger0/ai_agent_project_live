...
from app.routes.plugin_list import router as list_router
from app.routes.plugin_spec import router as spec_router
from app.routes.plugin_execute import router as exec_router
from app.routes.plugin_history import router as history_router
from app.routes import plugin_execute
